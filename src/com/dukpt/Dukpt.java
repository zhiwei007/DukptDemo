 ...
 */
/*
const BYTE PEK_MASK[] = "\x00\x00\x00\x00\x00\x00\x00\xFF\x00\x00\x00\x00\x00\x00\x00\xFF";
const BYTE MAC_MASK[] =    "\x00\x00\x00\x00\x00\x00\xFF\x00\x00\x00\x00\x00\x00\x00\xFF\x00";
const BYTE MAC_RES_MASK[] = "\x00\x00\x00\x00\xFF\x00\x00\x00\x00\x00\x00\x00\xFF\x00\x00\x00";
const BYTE DATA_REQ_MASK[] = "\x00\x00\x00\x00\x00\xFF\x00\x00\x00\x00\x00\x00\x00\xFF\x00\x00";
*/
//00000000000000FF00000000000000FF  PEK
//0000000000FF00000000000000FF0000  data
...
/*	public static final String KEY_REGISTER_BITMASK = "C0C0C0C000000000C0C0C0C000000000";
	 ...
	 * @throws Exception
	 */
	public static BitSet getIpek(BitSet key, BitSet ksn, BitSet keyRegisterBitmask) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static BitSet _getCurrentKey(BitSet ipek, BitSet ksn, BitSet keyRegisterBitmask, BitSet dataVariantBitmask) throws Exception {
	...
	public static byte[] encryptDes2(byte[] key, byte[] data ) throws  Exception {
		SecretKey encryptKey = SecretKeyFactory.getInstance("DES").generateSecret(new DESKeySpec(key));
		Cipher encryptor;
		encryptor = Cipher.getInstance("DES/ECB/NoPadding");
		encryptor.init(Cipher.DECRYPT_MODE, encryptKey);
		return encryptor.doFinal(data);
	}
